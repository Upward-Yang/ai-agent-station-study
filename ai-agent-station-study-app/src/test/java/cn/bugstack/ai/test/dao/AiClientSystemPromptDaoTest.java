...
public class AiClientSystemPromptDaoTest {
    ...
    public void test_deleteById() {
        int count = aiClientSystemPromptDao.deleteById(10L);
    ...
    public void test_queryById() {
        AiClientSystemPrompt aiClientSystemPrompt = aiClientSystemPromptDao.queryById(10L);
        log.info("查询系统提示词配置: {}", aiClientSystemPrompt);
    }

    @Test
    public void test_queryByPromptId() {
        AiClientSystemPrompt aiClientSystemPrompt = aiClientSystemPromptDao.queryByPromptId("test_001");

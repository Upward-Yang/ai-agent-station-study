...
/**
 * @Auther: yangjian
 * @Date: 2025-10-21 - 10 - 21 - 14:55
 * @Description: cn.bugstack.ai.test.spring.ai
 * @version: 1.0
 */
@Slf4j
        ...
        chatModel = OpenAiChatModel.builder()
                ...
                .defaultOptions(OpenAiChatOptions.builder()
                        ...
                        .toolCallbacks(new SyncMcpToolCallbackProvider(
                                stdioMcpClient(), sseMcpClient01(), sseMcpClient02()).getToolCallbacks())
                        .build())
                .build();
...
//                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(), sseMcpClient02()))
    ...
    public McpSyncClient stdioMcpClient() {
        ...
        var stdioParams = ServerParameters.builder("D:\\tool\\NodeJs\\setuped\\npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "C:\\Users\\yangjian\\Desktop", "C:\\Users\\yangjian\\Desktop")
                .build();
    ...
    public McpSyncClient sseMcpClient02() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://172.21.80.1:8101").build();

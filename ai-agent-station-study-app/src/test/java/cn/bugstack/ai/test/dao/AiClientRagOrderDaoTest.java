...
public class AiClientRagOrderDaoTest {
    ...
    public void test_deleteById() {
        int result = aiClientRagOrderDao.deleteById(4L);
    ...
    public void test_queryById() {
        AiClientRagOrder aiClientRagOrder = aiClientRagOrderDao.queryById(4L);
        log.info("根据ID查询结果: {}", aiClientRagOrder);
    }

    @Test
    public void test_queryByRagId() {
        AiClientRagOrder aiClientRagOrder = aiClientRagOrderDao.queryByRagId("test_rag_001");

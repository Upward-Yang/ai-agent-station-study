...
/**
 * @Auther: yangjian
 * @Date: 2025-10-23 - 10 - 23 - 10:08
 * @Description: cn.bugstack.ai.domain.agent.service.armory.factory.element
 * @version: 1.0
 */
public class RagAnswerAdvisor implements BaseAdvisor {
    ...
    public ChatClientResponse after(ChatClientResponse chatClientResponse, AdvisorChain advisorChain) {
        ...
        chatResponseBuilder.metadata("qa_retrieved_documents", chatClientResponse.context()
    ...
    public ChatClientResponse adviseCall(ChatClientRequest chatClientRequest, CallAdvisorChain callAdvisorChain) {
        ChatClientResponse chatClientResponse = callAdvisorChain.nextCall(
                this.before(chatClientRequest, callAdvisorChain));
